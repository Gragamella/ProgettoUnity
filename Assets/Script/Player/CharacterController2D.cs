...
public class CharacterController2D : MonoBehaviour
{
	...
	public const float k_GroundedRadius = .03f; // Radius of the overlap circle to determine if grounded
	public bool m_Grounded;            // Whether or not the player is grounded.
	public const float k_CeilingRadius = .04f; // Radius of the overlap circle to determine if the player can stand up
